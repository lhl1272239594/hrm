package com.jims.common.chart;


import com.jims.common.utils.DateUtil;
import com.jims.common.utils.NumberUtil;
import com.jims.common.utils.TwdConstant;
...
//		initGridDynamicData(chart, map);
	...
	{
        BaseDto baseDto= (BaseDto) map.get("jibenMap");
		chart.addBackgroundValue("姓 名：", grid_left / 3, bottom_length + y_grid_length + top_row_height * 5 + 0.1, font);
		chart.addBackgroundValue(baseDto.getAsString("name"), grid_left / 2 + x_unit / 2, bottom_length + y_grid_length + top_row_height * 5
				+ 0.1, font);
		chart.addBackgroundValue("入 院 日 期：", grid_left / 2 + x_unit / 3 + x_unit, bottom_length + y_grid_length
				+ top_row_height * 5 + 0.1, font);
		chart.addBackgroundValue(baseDto.getAsString("datezhu"), grid_left / 2 + x_unit * 2, bottom_length + y_grid_length
				+ top_row_height * 5 + 0.1, font);
		chart.addBackgroundValue("科 室：", grid_left / 2 + x_unit * 3, bottom_length + y_grid_length + top_row_height * 5
				+ 0.1, font);
		chart.addBackgroundValue(baseDto.getAsString("dept_name"), grid_left / 2 + x_unit * 3 + x_unit, bottom_length + y_grid_length
				+ top_row_height * 5 + 0.1, font);
		chart.addBackgroundValue("床 号：", x_length - x_unit * 2 - 3, bottom_length + y_grid_length + top_row_height * 5
				+ 0.1, font);
		chart.addBackgroundValue(baseDto.getAsString("bed_no"), x_length - x_unit * 2, bottom_length + y_grid_length + top_row_height * 5
				+ 0.1, font);
		chart.addBackgroundValue("住 院 号：", x_length - x_unit - 2, bottom_length + y_grid_length + top_row_height * 5
				+ 0.1, font);
		chart.addBackgroundValue(baseDto.getAsString("inp_no"), x_length - x_unit / 2 - 2, bottom_length + y_grid_length + top_row_height * 5
				+ 0.1, font);

//
//        chart.addBackgroundValue("体温", grid_left / 2 + x_unit * 3 + x_unit + 7, bottom_length + y_grid_length + top_row_height * 6 + 0.2,
//                font);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_temperatures_kw", x_length - x_unit * 2 - 0.6, (bottom_length + y_grid_length + top_row_height * 6) + 0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_line_pulse_2", x_length - x_unit * 2 - 0.6, (bottom_length + y_grid_length + top_row_height * 6) + 0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_line_pulse_2",  x_length - x_unit * 2+1.5, (bottom_length + y_grid_length + top_row_height * 6)+0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_temperatures_kw",  x_length - x_unit * 2+1.5, (bottom_length + y_grid_length + top_row_height * 6)+0.25);
//
//        chart.addBackgroundValue("脉搏", x_length - x_unit * 2+3, bottom_length + y_grid_length + top_row_height * 6 + 0.2,
//                font);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_pulse_1_1", x_length - x_unit * 2+4+0.2, (bottom_length + y_grid_length + top_row_height * 6) + 0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_line_reductionTemperature_1_5", x_length - x_unit * 2+4+0.2, (bottom_length + y_grid_length + top_row_height * 6) + 0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_line_reductionTemperature_1_5", x_length - x_unit * 2+6+0.2, (bottom_length + y_grid_length + top_row_height * 6) + 0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_pulse_1_1", x_length - x_unit * 2+6+0.2, (bottom_length + y_grid_length + top_row_height * 6) + 0.25);
//
//        chart.addBackgroundValue("心率", x_length - x_unit+2, bottom_length + y_grid_length + top_row_height * 6 + 0.2,
//                font);
...
//       chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_temperatures", x_length - x_unit/3-0.7, (bottom_length + y_grid_length + top_row_height * 6)+0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_temperatures",  x_length - x_unit/3+1, (bottom_length + y_grid_length + top_row_height * 6)+0.25);
//        chart.addData(ChartProcessor.AXIS_LEFT, "grid_point_heartRate_1_1",  x_length - x_unit/3+1, (bottom_length + y_grid_length + top_row_height * 6)+0.25);
		chart.addBackgroundValue("体  温  单", x_length / 2, bottom_length + y_grid_length + top_row_height * 6 + 0.1,
				new Font("SansSerif", Font.PLAIN, 15));
		chart.addBackgroundValue("医院名称", x_length / 2, bottom_length + y_grid_length + top_row_height * 8 + 0.1,
		...
		if (twdDateList != null && twdDateList.size() > 0)
		{
			for (int i = 0; i < twdDateList.size(); i++)
			{
                ...
                long diffDays = DateUtil.getDateDiff(DateUtil.parseDate(dateList.get(i)), DateUtil.parseDate(map.get("indate").toString()));
                // 住院日数
