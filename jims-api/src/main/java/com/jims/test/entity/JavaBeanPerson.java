...
public class JavaBeanPerson {
	...
	public static List<JavaBeanPerson> getListChs() {
		List<JavaBeanPerson> list = new ArrayList<JavaBeanPerson>();
		list.add(new JavaBeanPerson("李莉", "女", 22, "湖北", "10086"));
		list.add(new JavaBeanPerson("马可", "男", 33, "北京", "13800000000"));
		list.add(new JavaBeanPerson("安迪", "男", 44, "香港", "13812345678"));
		list.add(new JavaBeanPerson("琳达", "女", 28, "广西", "18677778888"));
		list.add(new JavaBeanPerson("杰西", "女", 26, "甘肃", "18219177720"));
		return list;
	}
}
