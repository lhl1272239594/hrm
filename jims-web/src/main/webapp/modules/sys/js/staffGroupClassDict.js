function onloadMethod() {
    $('#list_data').datagrid({
        ...
        fit: true,//自动大小
        url:basePath+'/StaffGroupClassDict/list',
        //sortName: 'code',
        //sortOrder: 'desc',
        remoteSort: false,
        idField: 'fldId',
        ...
        columns: [[      //每个列具体内容
            ...
            {field: 'serialNo', title: '序号', width: '10%', align: 'center'},
            {field: 'groupClass', title: '组类', width: '10%', align: 'center'},
        ...
        toolbar: [{
            ...
            iconCls: 'icon-add',
            handler: function () {
                $("#staffGroupClassDictForm").form('clear');
...
function del(id) {
    $.ajax({
        'type': 'POST',
        'url': basePath + '/StaffGroupClassDict/del',
...
function get(id) {
    ...
    $.ajax({
        'type': 'post',
        'url': basePath + '/StaffGroupClassDict/get',
        'contentType': 'application/json',
        'data': id = id,
        'dataType': 'json',
        'success': function (data) {
