function onloadMethod() {
    $('#list_data').datagrid({
        ...
        columns: [[      //每个列具体内容
            ...
            {field: 'deptCode', title: '科室代码', width: '10%', align: 'center'},
            {field: 'wardCode', title: '病房代码', width: '18%', align: 'center'},
