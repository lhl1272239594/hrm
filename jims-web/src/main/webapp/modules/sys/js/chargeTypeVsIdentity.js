function onloadMethod() {
    $('#list_data').datagrid({
        ...
        fit: true,//自动大小
        url:basePath+'/ChargeTypeVsIdentity/list',
        //sortName: 'code',
        //sortOrder: 'desc',
        remoteSort: false,
        idField: 'fldId',
        ...
        columns: [[      //每个列具体内容
            ...
            {field: 'identitySerialNo', title: '身份', width: '10%', align: 'center'},
            {field: 'identity', title: '身份序号', width: '18%', align: 'center'},
        ...
        toolbar: [{
            ...
            iconCls: 'icon-add',
            handler: function () {
                $("#chargeTypeVsIdentityForm").form('clear');
...
function del(id) {
    $.ajax({
        'type': 'POST',
        'url': basePath + '/ChargeTypeVsIdentity/del',
...
function get(id) {
    ...
    $.ajax({
        'type': 'post',
        'url': basePath + '/ChargeTypeVsIdentity/get',
        'contentType': 'application/json',
        'data': id = id,
        'dataType': 'json',
        'success': function (data) {
