...
<html>
  <head>
    <title>社保项目管理</title>
      ...
      <script type="text/javascript" src="/modules/fbd/hrm/peinfo/js/humanSkillLevel.js"></script>
  ...
  <div id="tb"  style="padding:5px;background:#eee;display: none">
  ...
  <div id="editWin"  style="height:240px;width:380px;"   data-options="modal:true,footer:'#dlg-buttons'">
      <form id="editForm" data-options="fit:true" method="post">
          ...
          <table class="editTable">
              <div  class="fitem">
                  <label style="width: 90px;">技能等级：</label>
                        <input  class="easyui-textbox" id="LEVEL"  style="width: 150px;height:27px"/>
              </div>
              <div class="fitem">
                  <label style="width: 90px;">人员技能：</label>
                        <input class="easyui-combobox" id="SKILL" panelHeight="140px" style="width:150px;height:27px" editable="false" />
              </div>
          </table>
      </form>
  </div>
