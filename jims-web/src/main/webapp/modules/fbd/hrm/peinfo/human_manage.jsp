...
<div id="ft" style="padding:5px;display: none">
   ...
   <%-- 科室:
    ...
    <a id="editBtn" class="easyui-linkbutton" data-options="iconCls:'icon-edit'">修改人员</a>
...
<script type="text/javascript" src="/modules/fbd/hrm/peinfo/js/humanManage.js"></script>
