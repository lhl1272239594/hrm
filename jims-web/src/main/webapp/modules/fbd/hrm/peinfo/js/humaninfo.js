...
$(function () {
    ...
    $("#EDUCATION").combobox({
        ...
        onShowPanel:function(){
            ...
            $.get(basePath + '/dict/find-list-by-type1?type=' + 'EDUCATION_DICT', function (data) {
                $("#EDUCATION").combobox('loadData',data);
            });
        }
    });
...
function save() {
    ...
    if($("#human_classify").textbox('getText')=='在编'){
        $("#come_time").datebox('setValue','');
    }
    if($("#human_classify").textbox('getText')=='聘用'){
        $("#work_time").datebox('setValue','');
    }
