...
//查询条件：审批状态
    ...
    $("#primaryGrid").edatagrid({
        ...
        url: basePath + '/overTime/myovertime?orgId=' + orgId + '&approveStatus=' + approveStatus+'&month='+month,
        remoteSort: false,
    ...
    var searchAllData=function (page,rows) {
        ...
        $("#primaryGrid").datagrid('reload', basePath + '/overTime/myovertime?orgId=' + orgId + '&approveStatus=' + approveStatus+ '&page=' + page+ '&rows=' + rows+'&month='+month);
        if(search){
            search=false;
