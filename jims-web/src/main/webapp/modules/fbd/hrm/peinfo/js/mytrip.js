...
//查询条件：审批状态
    ...
    $("#primaryGrid").edatagrid({
        ...
        rownumbers: true,//行号
        url: basePath + '/tripWork/mytrip?orgId=' + orgId +'&approveStatus=' + approveStatus+'&month='+month,
        columns: [[
    ...
    var searchAllData=function (page,rows) {
        ...
        $("#primaryGrid").datagrid('reload', basePath + '/tripWork/mytrip?orgId=' + orgId +'&approveStatus=' + approveStatus+ '&page=' + page+ '&rows=' + rows+'&month='+month);
        if(search){
            search=false;
