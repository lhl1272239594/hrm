...
<html>
  <head>
    <title>合同管理</title>
      ...
      <script type="text/javascript" src="/modules/fbd/hrm/contract/js/contract_probation_period.js"></script>
  ...
  <div id="editWin"  style="height:250px;width:360px;"   data-options="modal:true,footer:'#dlg-buttons'">
      <form id="editForm" data-options="fit:true" method="post" enctype="multipart/form-data">
          ...
          <table class="editTable">
                  <div  class="fitem">
                      <label style="width: 60px;" >试用期：</label>
                      <input  id="editProbationPeriodTimes" class="easyui-numberspinner"  data-options="min:0,max:365"style="width: 150px;height:27px"  />天
                  </div>
              <div  class="fitem">

              <label style="width: 60px;" >提醒时间：</label>
                  <input  id="editRemindTime" class="easyui-numberspinner"  data-options="min:0,max:365"style="width: 150px;height:27px"  />天
                  </div>
