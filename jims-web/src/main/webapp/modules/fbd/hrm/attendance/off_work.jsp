...
<head>
    ...
    <script type="text/javascript" src="/modules/fbd/hrm/attendance/js/off_work.js"></script>
    <script type="text/javascript" src="/modules/fbd/hrm/attendance/js/att_user_tree.js"></script>
    <script type="text/javascript" src="/modules/fbd/hrm/attendance/js/radio.js"></script>
...
<%--人员选择--%>
<div id="choosePerson" style="height: 500px;width:800px;display: none"
     data-options="modal:true,footer:'#choose-buttons'">
...
<div id="editWin" style="height:400px;width:560px;" data-options="modal:true,footer:'#dlg-buttons'">
    <form id="editForm" data-options="fit:true" method="post">
        ...
        <table class="editTable">
            ...
            <div class="fitem">
                ...
                <input class="easyui-combobox" id="editHolidayType" data-options="multiline:true,editable:false"
                       style="width:150px;height:27px"/>
            ...
            <div class="fitem">
                ...
                <input class="easyui-textbox" id="editOffWorkReason" data-options="multiline:true"
                       style="width:365px;height:90px"/>
...
<div id="infoWin" style="height:350px;width:540px;" data-options="modal:true">
    ...
    <table class="editTable">
        ...
        <div class="fitem">
            ...
            <label style="width: 60px;">所在部门：</label>
            <input id="DeptName" class="easyui-textbox" data-options="multiline:true,editable:false"
                   style="width: 150px;height:27px"/>
        </div>
        <div class="fitem">
            <label style="width: 60px;">开始时间：</label>
            <input id="StartDate" class="easyui-textbox" data-options="multiline:true,editable:false"
                   style="width:150px;height:27px"/>

            <label style="width: 60px;">结束时间：</label>
            <input id="EndDate" class="easyui-textbox" data-options="multiline:true,editable:false"
                   style="width:150px;height:27px">
        </div>

        <div class="fitem">
            <label style="width: 60px;">假期类型：</label>
            <input class="easyui-textbox" id="HolidayType" data-options="multiline:true,editable:false"
                   style="width:150px;height:27px"/>
        ...
        <div class="fitem">
            <label style="width: 60px;">请假原因：</label>
            <input class="easyui-textbox" id="OffWorkReason" data-options="multiline:true,editable:false"
                   style="width:365px;height:90px"/>
