...
<html>
  <head>
    <title>公出管理</title>
      ...
      <script type="text/javascript" src="/modules/fbd/hrm/attendance/js/trip_work.js"></script>
  ...
  <div id="editWin"  style="height:350px;width:540px;"   data-options="modal:true,footer:'#dlg-buttons'">
      <form id="editForm" data-options="fit:true" method="post">
          ...
          <table class="editTable">
              <div  class="fitem">
                  <label style="width: 65px;" >公出人员：</label>
          ...
          <div class="fitem">
              <label style="width: 65px;" >出发地：</label>
              <input class="easyui-textbox" id="editTripWorkPlace" data-options="multiline:true" style="width: 150px;height:27px" />

                  <label style="width: 60px;" >目的地：</label>
                  <input class="easyui-textbox" id="editTripWorkDestination" data-options="multiline:true" style="width: 150px;height:27px" />

              </div>

                  <div class="fitem">
                      <label style="width: 65px;"  >公出原因：</label>
                      <input class="easyui-textbox" id="editTripWorkReason" data-options="showSeconds:false,multiline:true" style="width:365px;height:90px"  />
  ...
  <div id="infoWin"  style="height:350px;width:540px;"   data-options="modal:true">
      ...
      <table class="editTable">
          ...
          <div  class="fitem"  style="margin-top: 10px;">
              <label style="width: 60px;" >公出人员：</label>
          ...
          <div class="fitem">
              <label style="width: 65px;" >出发地：</label>
              <input class="easyui-textbox" id="TripWorkPlace" data-options="multiline:true,editable:false" style="width: 150px;height:27px" />

              <label style="width: 60px;" >目的地：</label>
              <input class="easyui-textbox" id="TripWorkDestination" data-options="multiline:true,editable:false" style="width: 150px;height:27px" />

          </div>

          <div class="fitem">
              <label style="width: 65px;"  >公出原因：</label>
              <input class="easyui-textbox" id="TripWorkReason" data-options="multiline:true,editable:false" style="width:365px;height:90px"  />
