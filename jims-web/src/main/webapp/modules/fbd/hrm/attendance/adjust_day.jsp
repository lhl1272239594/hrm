...
<html>
  <head>
    <title>调休管理</title>
      ...
      <script type="text/javascript" src="/modules/fbd/hrm/attendance/js/adjust_day.js"></script>
  ...
  <div id="editWin"  style="height:300px;width:540px;"   data-options="modal:true,footer:'#dlg-buttons'">
      <form id="editForm" data-options="fit:true" method="post">
          ...
          <table class="editTable">
              <div  class="fitem">
                  <label style="width: 60px;" >调休人员：</label>
              ...
              <div  class="fitem">
                  ...
                  <select  id= "editAdjustDayType"class="easyui-combobox" data-options="editable:false"  style="width:150px;height:27px" panelHeight="auto">
                      <option value="1">加班存休</option>
                      <option value="2">带薪假期</option>
                  </select>
              </div>
                  <div id="holidayType" class="fitem">
                      <label style="width: 60px;" >假期名称：</label>
                      <input class="easyui-combobox" id="editHolidayType" data-options="showSeconds:false,multiline:true,editable:false"  style="width:150px;height:27px"  />
                  </div>
              </table>
      </form>
  </div>
  ...
  <div id="infoWin"  style="height:260px;width:540px;"   data-options="modal:true">
      ...
      <table class="editTable">
          ...
          <div class="fitem">
              <label style="width: 60px;" >调休类型：</label>
              <input class="easyui-textbox" id="AdjustDayType" data-options="multiline:true,editable:false"  style="width:150px;height:27px"  />
              <span id="holiday">
                  <label style="width: 60px;"  >假期名称：</label>
                  <input class="easyui-textbox" id="Type" data-options="multiline:true,editable:false" style="width:150px;height:27px" />
