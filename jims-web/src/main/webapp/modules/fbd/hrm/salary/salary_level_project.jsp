...
<div id="tb" style="padding:5px">
    工资级别：
    <select id="levelId" class="easyui-combobox" panelHeight="auto" data-options="editable:false" style="width:140px">

    </select>
    工资项目：
    <select id="projectId" class="easyui-combobox" panelHeight="auto" data-options="editable:false" style="width:140px">
...
<!-- 新增编辑框start -->
<div id="newDialog" style="height:220px;width:auto;" data-options="modal:true,footer:'#dlg-buttons'">
    <form id="newForm" method="post" data-options="fit:true">
        <input type="hidden" id="LPID" />

        <div class="fitem" style="margin-left: -70px">
            <label>工资级别：</label>
            <select id="LEVEL_ID" name="LEVEL_ID" class="easyui-combobox" style="width:200px;height:27px" data-options="editable:false" required="true"></select>
        </div>

        <div class="fitem" style="margin-left: -70px">
            <label>工资项目：</label>
            <select id="PROJECT_ID" name="PROJECT_ID" class="easyui-combobox" style="width:200px;height:27px" data-options="editable:false" required="true"></select>
        </div>
...
<script type="text/javascript" src="/modules/fbd/hrm/salary/js/salary_level_project.js"></script>
