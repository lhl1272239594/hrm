...
<div id="tb" style="padding:5px;display: none">
    项目名称：<input id="projectName" type="text" class="easyui-textbox" style="width:140px">
...
<div id="newDialog" style="height:160px;width:370px;display: none" data-options="modal:true,footer:'#dlg-buttons'">
    <form id="newForm" method="post" data-options="fit:true">
        ...
        <div class="fitem" >
            ...
            <input id="PROJECT_NAME" class="easyui-textbox" style="width:200px;height:27px" >
        </div>
    </form>
</div>
...
<script type="text/javascript" src="/modules/fbd/hrm/salary/js/salary_project.js"></script>
