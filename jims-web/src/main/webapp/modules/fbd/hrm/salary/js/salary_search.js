...
$(function () {
    ...
    $("#dataGrid").datagrid({
        ...
        url: basePath + '/salary-tmp/salary-history-list?orgId='+orgId+'&personName='+personName+'&deptId='+deptId+'&typeId='+typeId+'&salaryMonth='+salaryMonth+'&deptIds='+deptIds,
        remoteSort: false,
        //idField: 'tmpId',
...
*/
    ...
    var searchData= function (page,rows){
        ...
        $("#dataGrid").datagrid('reload', basePath + '/salary-tmp/salary-history-list?orgId='+orgId+'&personName='+personName+'&deptId='+deptId+'&typeId='+typeId+'&salaryMonth='+salaryMonth+'&deptIds='+deptIds+'&page='+page+'&rows='+rows);
            if(search){
                search=false;
                if(page!='1') {
